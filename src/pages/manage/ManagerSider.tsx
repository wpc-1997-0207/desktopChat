...
const Links = [
  {
    label: t("placeholder.businessAudit"),
    icon: new_friends,
    path: "/manage/audit",
  },
  {
    label: t("placeholder.businessList"),
    icon: group_notifications,
    path: "/manage/businessList",
  },
  {
...
i18n.on("languageChanged", () => {
  Links[0].label = t("placeholder.businessAudit");
  Links[1].label = t("placeholder.businessList");
  Links[2].label = t("placeholder.userList");
});
